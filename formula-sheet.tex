...
\begin{itemize}
  ...
  \item $E_{oi}$ = infallande våg
  \item $E_{or}$ = reflekterande våg
  \item $E_{ob}$ = brytningsvåg
  \item $I$ = intensitet
  \item $n$ = brytningsindex
\end{itemize}
Intensitet hos plan elektromagnetisk våg vakuum ($\cdot n$ för dielektrikum):
...
Tidsmedelvärdet ($\cdot \varepsilon_r$ för dielektrikum):
...
För vinkelrätt infall mot infallsplanet (ingen brewstervinkel)
